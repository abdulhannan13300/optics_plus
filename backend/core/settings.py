...
SECRET_KEY = 'django-insecure-9_)iwr93p)itl2y#xd=9n4hpb(bs0uuor94ys2xjbr5$-b4cmk'
...
MIDDLEWARE = [
    ...
    'optics.middleware.CustomJWTAuthenticationMiddleware',
    # 'optics.middleware.MultitenantMiddleware'
...
# DATABASE_ROUTERS = ['django_multitenant.db.MultiTenantRouter']
